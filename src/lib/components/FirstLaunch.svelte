<script lang="ts">
  ...
  const MODELS = {
    Standard: [
      ...
      { id: "gemma-4-e2b", name: "Gemma 4 E2B IT", filename: "google_gemma-4-E2B-it-Q4_K_M.gguf", url: "https://huggingface.co/bartowski/google_gemma-4-E2B-it-GGUF/resolve/main/google_gemma-4-E2B-it-Q4_K_M.gguf" }
    ],
    Elite: [
      { id: "bge-small", name: "BGE Small v1.5", filename: "bge-small-en-v1.5.onnx", url: "https://huggingface.co/BAAI/bge-small-en-v1.5/resolve/main/onnx/model.onnx" },
      { id: "tokenizer", name: "BGE Tokenizer", filename: "tokenizer.json", url: "https://huggingface.co/BAAI/bge-small-en-v1.5/resolve/main/tokenizer.json" },
      { id: "gemma-4-e4b", name: "Gemma 4 E4B IT", filename: "google_gemma-4-E4B-it-Q4_K_M.gguf", url: "https://huggingface.co/bartowski/google_gemma-4-E4B-it-GGUF/resolve/main/google_gemma-4-E4B-it-Q4_K_M.gguf" }
    ]
  };
