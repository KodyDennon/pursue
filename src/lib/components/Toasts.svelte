...
<style>
  ...
  .toast-card.success .toast-icon { color: var(--accent-success); }
  .toast-card.error .toast-icon { color: var(--accent-danger); }
  .toast-card.info .toast-icon { color: var(--accent-primary); }
  .toast-card.loading .toast-icon { color: var(--text-secondary); }
